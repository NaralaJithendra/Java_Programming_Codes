...
public class Hash_Map {
	...
	public static void main(String[] args) {
		...
		System.out.println("All Values in HashMap: "+map.values());//Output: All Values in HashMap: [, January, Febraury, March, April, May, June, July, August, September, October, November, December]
		
		System.out.println(map.containsKey("January"));//Output: false
